                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      <ul className="submenu">
                        ...
                        <li>
                          <Link to="/practice-details">practice details</Link>
                        </li>
                      </ul>
                    </li>
                    <li>
                      ...
                      <ul className="submenu">
                        <li>
                          <Link to="/case-stadies">Cases</Link>
                        </li>
                        <li>
                          <Link to="/case-stadies-details">Case single</Link>
                        </li>
                      </ul>
                    </li>
                    <li>
                      ...
                      <ul className="submenu">
                        ...
                        <li>
                          <Link to="/blog-list">Blog with sidebar</Link>
                        </li>
                        <li>
                    ...
                    <li>
                      ...
                      <ul className="submenu">
                        ...
                        <li>
                          <Link to="/Attorneys-single">Attorney Single</Link>
                        </li>
                        <li>
